...
1. Enter the property price, down payment, mortgage terms, and purchase date.
2. Add expected rental income and operating expenses.
3. Enter appreciation, tax, depreciation, and sale assumptions.
4. Configure the alternative investment’s expected return and contributions.
5. Review the results, charts, and annual projections.
...
Tax estimates may include depreciation and eligible expenses described in [IRS Publication 527](https://www.irs.gov/publications/p527). Eligibility depends on how the property is used and your individual tax circumstances.
